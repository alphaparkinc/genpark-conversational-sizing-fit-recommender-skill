# genpark-conversational-sizing-fit-recommender-skill
...
**genpark-conversational-sizing-fit-recommender-skill** is a deterministic, zero-dependency Python skill engineered for autonomous consumer shopping agents, checkout tokenization, and e-commerce decision intelligence.

> **Executive Capability**: Conversational apparel sizing & fit recommender (Rufus / Shop AI)
...
```mermaid
graph LR
    User([🌐 Shopper / Commerce Agent]) -->|JSON-RPC Request| MCP[⚡ MCP Server / CLI]
...
result = client.recommend_best_fit()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-conversational-sizing-fit-recommender-skill": {
      "command": "python",
      "args": ["/path/to/genpark-conversational-sizing-fit-recommender-skill/mcp_server.py"]
    }
  }
}
```
...
Explore the comprehensive directory of 1,200+ open-source, production-ready AI Agent skills at the [GenPark AI MCP Hub](https://genpark.ai/mcp) and learn more about autonomous shopping and commerce at [GenPark AI](https://genpark.ai).
